...
public class App {
	...
	public static void sendSMS() throws InterruptedException {
        ...
        ExtentHtmlReporter spark=new ExtentHtmlReporter("C:\\Users\\chinthala.teja\\Downloads\\ExtentReports\\App.html");
		...
		LoginObjects.setTextInMobileBox("9391972464");
		// Adding a wait of 3 seconds
		Thread.sleep(3000);
		// Calling the method clickSendSMSBox from the LoginObjects class
		LoginObjects.clickSendSMSBox();
		// Adding a wait of 3 seconds
		Thread.sleep(3000);
