...
//Class to test the functionality of buying a product from Asian Paints website
public class BuyNow {
    ...
    public void addTocart() throws InterruptedException {
        ...
        ExtentHtmlReporter spark=new ExtentHtmlReporter("C:\\Users\\chinthala.teja\\Downloads\\ExtentReports\\BuyNow.html");
        ...
        // Adding wait time of 3 seconds
        Thread.sleep(3000);
        // Calling the clickCheckButton method from the PaintObjects class
        PaintObjects.clickCheckButton();
        // Adding wait time of 3 seconds
        Thread.sleep(3000);
     // Calling the clickBuyNowButton method from the PaintObjects class
        PaintObjects.clickBuyNowButton();
        // Adding wait time of 3 seconds
        Thread.sleep(3000);
