	...
	public static void LoginTest() throws InterruptedException {
     ...
     // Initializing the ExtentReports instance
       ...
       // Creating an instance of ExtentHtmlReporter to specify the location and name of the HTML report
        ExtentHtmlReporter spark=new ExtentHtmlReporter("C:\\Users\\chinthala.teja\\Downloads\\ExtentReports\\Contractor.html");
     // Attaching the HTML report to the ExtentReports instance
		...
		Thread.sleep(3000);
		// Calling the method clickfindcontractorButton from the LoginObjects class
		LoginObjects.clickfindcontracorButton();
		// Adding a wait of 3 seconds
		Thread.sleep(3000);
		// Calling the method setTextInPinCodeBox from the LoginObjects class
		LoginObjects.setTextInPinCodeBox("110001");
		// Adding a wait of 3 seconds
		Thread.sleep(3000);
		// Calling the method clickAppButton from the LoginObjects class
		LoginObjects.clickSearchButton();
		// Adding a wait of 3 seconds
		Thread.sleep(3000);
